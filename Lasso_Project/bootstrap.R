...
for (i in 1:times) {
  ...
  gfit = glmnet(xx_normal,yy_normal,thresh=1E-10,standardize=FALSE)
  n=dim(data_x)[1]
  beta = coef(gfit, x=xx_normal, y=yy_normal, s=average_best_lambda/n, exact=TRUE)[-1]
  
  result = fixedLassoInf(xx_normal,yy_normal,beta,average_best_lambda,
