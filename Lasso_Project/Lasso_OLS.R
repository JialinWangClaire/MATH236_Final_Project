...
Var
Coef_full <- result_normal$coef0
LowConfPt_full <- result_normal$ci[,1]
UpConfPt_full <- result_normal$ci[,2]
LowConfPt <- LowConfPt_full
UpConfPt <- UpConfPt_full
...
LowConfPt_ols <- LowConfPt_ols_full[-c(1,6)]
UpConfPt_ols_full<- tail(UpConfPt_ols_try,-1)
UpConfPt_ols <- UpConfPt_ols_full[-c(1,6)]
...
p <- ggplot(data_ols, aes(Var, Coef_full)) +  
