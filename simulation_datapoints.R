...
#plot
plot(unlist(real_seq),unlist(empirical_loss_list), type="l", col="brown", lwd=3, xlab="number of data points", ylab="empirical_loss", main="Influence of number of data points")
